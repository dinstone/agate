...
public class ManageService {
	...
	private ApiConfig covert(RouteEntity apiEntity) {
	...
	private RouteEntity covert(ApiConfig apiConfig) {
	...
	private String convertApiOption(GatewayEntity gatewayEntity, RouteEntity apiEntity) {
	...
	private boolean existRouteKey(RouteEntity route) {
