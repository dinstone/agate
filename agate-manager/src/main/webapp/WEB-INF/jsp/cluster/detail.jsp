							...
							<div class="box-content">
								...
								<form role="form" action="#">
									...
									<div class="form-group">
										<label>Code (Global Uniqueness) <i class="glyphicon glyphicon-star red"></i></label> <input type="text" class="form-control" name="cluster" value="${cluster.code}" disabled="disabled">
									</div>
									<div class="form-group">
										<label>Name (Cluster Uniqueness) <i class="glyphicon glyphicon-star red"></i></label> <input type="text" class="form-control" name="name" value="${cluster.name}" disabled="disabled">
									</div>
								</form>
							</div>
						</div>
