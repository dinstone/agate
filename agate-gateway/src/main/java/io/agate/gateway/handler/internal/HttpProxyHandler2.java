...
import io.agate.gateway.handler.RoutingHandler;
...
import io.agate.gateway.options.RoutingOptions;
...
public class HttpProxyHandler2 implements RoutingHandler {
    ...
    // private void handleProxyRequest(ProxyRequest proxyRequest, HttpClientRequest inboundRequest,
